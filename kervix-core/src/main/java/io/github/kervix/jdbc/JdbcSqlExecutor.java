...
import io.github.kervix.api.ResultAssembler;
import io.github.kervix.api.ResultColumn;
import io.github.kervix.api.ResultRow;
...
public final class JdbcSqlExecutor implements SqlExecutor {
    ...
    private void logTerminalFailure(
        ...
        LOGGER.log(
            ...
            "Kervix interceptor terminal callback failed [interceptor="
