package io.github.kervix.test.transaction;
...
import io.github.kervix.api.TransactionCallback;
import io.github.kervix.api.TransactionException;
import io.github.kervix.api.TransactionalExecutor;
...
class TransactionContractTest {
    ...
    @Test
    void transactionFailuresAreUncheckedKervixExceptions() {
