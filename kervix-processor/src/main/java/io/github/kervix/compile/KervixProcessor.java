 ...
 * @since 2024/09/29
 */
@SupportedAnnotationTypes("io.github.kervix.annotation.Mapper")
@SupportedSourceVersion(SourceVersion.RELEASE_21)
public class KervixProcessor extends AbstractProcessor {
    ...
    public synchronized void init(ProcessingEnvironment processingEnv) {
        ...
        messager.printMessage(Diagnostic.Kind.NOTE, "Kervix Processor initialized");
    }
    ...
    public boolean process(Set<? extends TypeElement> annotations, RoundEnvironment roundEnv) {
        ...
        messager.printMessage(Diagnostic.Kind.NOTE, "Kervix Processing started...");
        
        try {
            processMapperAnnotations(roundEnv);
            messager.printMessage(Diagnostic.Kind.NOTE, "Kervix Processing completed");
        } catch (RuntimeException exception) {
            messager.printMessage(Diagnostic.Kind.ERROR,
                "Unexpected Kervix processor failure: " + exception.getClass().getSimpleName()
