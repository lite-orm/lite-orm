...
public class TransactionBenchmark {
    ...
    @Benchmark
    public String liteOrm(TransactionState state) {
        return state.assembly.transactionalExecutor().execute(() -> state.liteOrm.scalar(500L));
    }
    ...
    public static class TransactionState {
        ...
        public void setup() throws Exception {
            ...
            assembly = LiteOrm.jdbc(dataSource).build();
