...
`lynxus` agent skill (migration mode). It is not a root Maven module and it
does not add MyBatis to any Lynxus runtime artifact.
...
- `src/main/`: the reviewed Lynxus conversion;
...
not converted here. Lynxus owns generated Mapper assembly and JDBC execution,
