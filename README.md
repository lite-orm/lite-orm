...
Lynxus is a lightweight, compile-time SQL Mapper for Java 21. It generates ordinary Java implementations from Mapper interfaces, annotations, and optional XML, then executes immutable plans through an explicit JDBC runtime.

Lynxus is not a feature-for-feature MyBatis clone. It focuses on explicit SQL, compile-time diagnostics, readable generated code, deterministic JDBC behavior, and a small runtime without Mapper proxies or runtime XML interpretation.
