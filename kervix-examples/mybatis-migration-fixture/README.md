...
`kervix` agent skill (migration mode). It is not a root Maven module and it
does not add MyBatis to any Kervix runtime artifact.
...
- `src/main/`: the reviewed Kervix conversion;
...
not converted here. Kervix owns generated Mapper assembly and JDBC execution,
