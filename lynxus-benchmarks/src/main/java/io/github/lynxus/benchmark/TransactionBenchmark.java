...
public class TransactionBenchmark {
    ...
    @Benchmark
    public String lynxus(TransactionState state) {
        return state.assembly.transactionalExecutor().execute(() -> state.lynxus.scalar(500L));
    }
    ...
    public static class TransactionState {
        ...
        public void setup() throws Exception {
            ...
            assembly = Lynxus.jdbc(dataSource).build();
