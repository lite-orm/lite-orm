...
/**
 * Lynxus Spring Boot configuration properties.
 * 
 * @author lynxus
 * @since 2024/11/15
 */
@ConfigurationProperties(prefix = "lynxus")
public class LynxusProperties {
    
    /**
     * Whether Lynxus auto-configuration is enabled.
     */
