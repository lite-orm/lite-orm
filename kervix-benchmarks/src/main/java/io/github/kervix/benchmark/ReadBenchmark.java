...
public class ReadBenchmark {
    ...
    @Benchmark public String kervixScalar(ReadState state) { return state.kervix.scalar(500L); }
    ...
    @Benchmark public BenchmarkRecord kervixRecord(ReadState state) { return state.kervix.record(500L); }
    @Benchmark public BenchmarkBean kervixBean(ReadState state) { return state.kervix.bean(500L); }
    ...
    @Benchmark
    public int kervixDynamic(ReadState state) {
        return state.kervix.dynamic("user-520", 30).size();
    }
    ...
    @Benchmark
    public long kervixCursor(ReadState state) {
        return state.kervix.scan(991L, cursor -> {
            long sum = 0;
            while (cursor.next()) {
    ...
    @Benchmark
    public BenchmarkRecord kervixNoopInterceptor(ReadState state, Blackhole blackhole) {
        BenchmarkRecord row = state.kervixObserved.record(500L);
    ...
    public static class ReadState {
        ...
        KervixBenchmarkMapper kervixObserved;
