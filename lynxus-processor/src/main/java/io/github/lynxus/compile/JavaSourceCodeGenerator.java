...
final class JavaSourceCodeGenerator implements CodeGenerator {
    ...
    private String generateReturnCode(MapperCompilationModel.MethodModel methodModel) {
        ...
        boolean isSelect = methodModel.statementType() == io.github.lynxus.api.ExecutionPlan.StatementType.SELECT;

        if (methodModel.statementType() == io.github.lynxus.api.ExecutionPlan.StatementType.BATCH) {
